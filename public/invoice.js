if (typeof window.currentRowCount === 'undefined') {
  window.currentRowCount = 0;
}

if (typeof window.base64Font === 'undefined') {
  window.base64Font = '';
}
...
function addRows(n) {
    ...
    for (let i = window.currentRowCount + 1; i <= window.currentRowCount + n; i++) {
...
function generatePDF1() {
    ...
    doc.addFileToVFS('NotoSansJP-VariableFont_wght.ttf', window.base64Font);
    ...
    const rawRows = [];
    let totalAmount = 0;
    for (let i = 1; i <= window.currentRowCount; i++) {
